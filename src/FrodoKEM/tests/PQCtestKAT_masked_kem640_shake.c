...
char    AlgName[] = "masked_FrodoKEM-640-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_masked_Frodo640(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_masked_Frodo640(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_masked_Frodo640(ss1, ct, sk)) != 0) {
