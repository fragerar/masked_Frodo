...
#include <ctype.h>
#include "rng.h"
#include "../src/api_masked_frodo976.h"

char    AlgName[] = "masked_FrodoKEM-976-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_masked_Frodo976(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_masked_Frodo976(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_masked_Frodo976(ss1, ct, sk)) != 0) {
