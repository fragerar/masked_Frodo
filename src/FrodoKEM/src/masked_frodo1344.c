...
#include "api_masked_frodo1344.h"
#include "frodo_macrify.h"


// Parameters for "masked_FrodoKEM-1344"
...
// CDF table
uint32_t CDF_TABLE[7] = {9142, 23462, 30338, 32361, 32725, 32765, 32767};
uint32_t CDF_TABLE_LEN = 7;
